...
async def execute_tool(
    client: OpenRMFClient, tool_name: str, params: Dict[str, Any]
) -> Any:
...
async def _get_robot_status(client: OpenRMFClient, params: Dict[str, Any]) -> Any:
    return await client.get_robot_state(
        params["fleet_name"], params["robot_name"]
    )
...
async def _decommission_robot(client: OpenRMFClient, params: Dict[str, Any]) -> Any:
    return await client.post_decommission_robot(
        params["fleet_name"], params["robot_name"]
    )
...
async def _recommission_robot(client: OpenRMFClient, params: Dict[str, Any]) -> Any:
    return await client.post_recommission_robot(
        params["fleet_name"], params["robot_name"]
    )
...
async def _control_door(client: OpenRMFClient, params: Dict[str, Any]) -> Any:
    return await client.post_door_request(
        params["door_name"], {"mode": params["mode"]}
    )
...
async def _respond_to_alert(client: OpenRMFClient, params: Dict[str, Any]) -> Any:
    return await client.post_alert_response(
        params["alert_id"], {"response": params["response"]}
    )
